...
//   return (
//     <div className="page"  style={{ backgroundColor:"#f4f5f7"}}>
...
//           </span>
//           <div className="lecture-meta text-gray-600 mt-2">
//              <span className="font-medium" style={{ fontWeight: 500 ,color:"black"}}>  By:{l.lecturerName}</span>
//             {user.role === "teacher" && (
//               <div style={{ marginTop: 4 }}>
//                 <span style={{ fontWeight: 500 ,color:"black"}}>Access Code:</span>{" "}
//                 <span
//                   style={{
  ...
  return (
    <div className="page">
      <div className="page-header">
        ...
        {/* Student: join by access code */}
        {user.role === "student" && (
          <form onSubmit={handleJoinByAccessCode} className="form-inline">
            <input
              type="text"
              value={accessCode}
              onChange={(e) => setAccessCode(e.target.value)}
      ...
      <div className="page-grid">
        {(user.role === "student"
          ? lectures.filter((l) => l.joinedLectures?.includes(user._id))
          : lectures
        ).map((l) => (
          <div key={l._id} className="card">
            ...
            {user.role === "teacher" && (
  <div className="lecture-access">
    <span style={{ fontWeight: "bold" }}>Access Code:</span>
    <span className="code" style={{ fontFamily: "monospace", marginLeft: "6px" }}>
      {l.accessId}
    </span>
    <span
      ...
      onClick={() => {
        navigator.clipboard.writeText(l.accessId);
